...
csvname = "Gelatin_degradation_raw.csv"
epsname = "Gelatin_degradation_plot.eps"
...
pal = sns.color_palette("viridis", 4)
g = sns.pointplot(y="Normalized degradation", x="Genotype", data=df3, order=["WT","KO", "KO_Inhibitor"], join=False)
g = sns.swarmplot(y="Normalized degradation", x="Genotype", hue="Experiment", data=df3,order=["WT","KO", "KO_Inhibitor"], palette=pal)
...
ax=sns.pointplot(x="Genotype", y="Normalized degradation", data=df3, join=False, order=["WT","KO", "KO_Inhibitor"], capsize=0.3, color="Black")
ax= sns.swarmplot(x="Genotype", y="Normalized degradation", data=df3, palette=pal2, order=["WT","KO", "KO_Inhibitor"], size=10)
