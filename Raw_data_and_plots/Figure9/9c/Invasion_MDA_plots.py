...
csvname = "MDA_invasion.csv"
epsname = "MDA_invasion.eps"
...
display_order=["MDA SCR", "MDA KD","Cherry SCR","Cherry KD"]
...
cat1_wt = df3[df3['Treatment']=='MDA SCR']
cat1_KO = df3[df3['Treatment']=='MDA KD']
